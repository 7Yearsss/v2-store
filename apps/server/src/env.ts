...
const schema = z.object({
  ...
  SHOPIFY_SCOPES: z
    .string()
    .default("write_products,read_products,read_inventory,write_inventory,read_locations,read_publications,write_publications,write_files,read_metaobjects,write_metaobjects,read_orders,write_merchant_managed_fulfillment_orders"),
